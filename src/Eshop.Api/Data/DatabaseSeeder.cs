...
/// Responsible for populating initial data during database creation or migration.
/// </summary>
public static class DatabaseSeeder
{
    /// <summary>
    /// Configures seed data for the database using the model builder.
    /// </summary>
    ...
    /// <summary>
    /// Gets the initial seed products for the database.
    /// </summary>
    /// <returns>Array of seed products</returns>
